...
namespace AUSJ
{
    ...
    public class LookingHandScreen : MonoBehaviour
    {
        ...
        private GameObject playerWatch = null;
	    ...
	    private void Start()
        {
            ...
            {
                throw new Exception("playerWatch TAG cannot be found");
            }
        }
	    ...
	    { // happen the first frame when I start looking at something
            ...
            // Stop notifications
            playerWatch.GetComponent<Watch>().LookingWatch = true;
        }
	    ...
	    { // will happen the first frame when I STOP looking at something
            ...
            playerWatch.GetComponent<Watch>().LookingWatch = false;
